    ...
    <div className="relative bg-gray-900 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-32 md:py-40">
        <div className="max-w-2xl">
          ...
          <p className="text-lg md:text-xl text-gray-200 mb-12 font-light leading-relaxed">
            Discover thoughtfully designed products for your everyday life
          </p>
          <Link
            to="/products"
            className="inline-block text-sm border border-white text-white px-8 py-3 hover:bg-white hover:text-gray-900 transition-all font-light tracking-wide"
          >
            EXPLORE COLLECTION
          </Link>
        </div>
